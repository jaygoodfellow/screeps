    ...
    run:  function(workForce) {
      ...
      if(spawn1.canCreateCreep){
        let spawnName = 'Spawn_' + Game.time
          ...
          spawn1.createCreep([MOVE,MOVE,CLAIM,CLAIM], spawnName, {'role':'Claimer', 'room':'W27N66'})
          ...
          spawn1.createCreep([WORK,WORK,WORK,MOVE,MOVE,MOVE,CARRY,CARRY,CARRY,CARRY], spawnName, {'role':'Builder', 'room':'W27N67', 'energySource': '57ef9d5d86f108ae6e60da45'})
