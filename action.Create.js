      ...
      if(spawn1.canCreateCreep){
        let spawnName = 'Spawn_' + Game.time
  			if (workForce.Harvester < 3) {
  				spawn1.createCreep([WORK,WORK,WORK,MOVE,MOVE,MOVE,MOVE,CARRY,CARRY,CARRY,CARRY,CARRY], spawnName, {'role':'Harvester', 'energySource': '57ef9d5d86f108ae6e60da45'})
          ...
          spawn1.createCreep([WORK,WORK,WORK,MOVE,MOVE,MOVE,CARRY,CARRY,CARRY,CARRY], spawnName, {'role':'Builder', 'energySource': '5835d51f22c10df7453a0a6a'})
        } else if (workForce.Longhauler < 3) {
          spawn1.createCreep([WORK,WORK,WORK,MOVE,MOVE,MOVE,CARRY,CARRY,CARRY,CARRY,CARRY], spawnName, {'role':'Longhauler'})
        }
      }
    }
};