      ...
      if(spawn1.canCreateCreep){
        let spawnName = 'Spawn_' + Game.time
  			...
  			if (workForce.Harvester < 2) {
  				spawn1.createCreep([WORK,MOVE,MOVE,CARRY,CARRY], spawnName, {'role':'Harvester', 'energySource': '57ef9d5d86f108ae6e60da45'})
        ...
        //   spawn1.createCreep([WORK,WORK,WORK,MOVE,MOVE], spawnName, {'role':'Miner'})
          ...
          spawn1.createCreep([WORK,WORK,MOVE,CARRY,CARRY,CARRY], spawnName, {'role':'Upgrader', 'energySource': '57ef9d5d86f108ae6e60da44'})
